  ...
  return (
    <div className="min-h-screen py-16 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-8 text-white text-center">Projects</h1>
        
        <AnimatedCard className="mb-8" delay={100}>
          <CardHeader>
            <div className="flex justify-between items-start">
              <CardTitle className="text-white">Quantitative Research - Commodity Storage Optimization</CardTitle>
        ...
        <AnimatedCard className="mb-8" delay={200}>
          <CardHeader>
            <div className="flex justify-between items-start">
              <CardTitle className="text-white">BeatPace</CardTitle>
              <div className="flex space-x-2">
                <a 
        ...
        <AnimatedCard className="mb-8" delay={300}>
          <CardHeader>
            <div className="flex justify-between items-start">
        ...
        <AnimatedCard className="mb-8" delay={400}>
          <CardHeader>
            <div className="flex justify-between items-start">
              <CardTitle className="text-white">Caustics Wave Simulation</CardTitle>
              <div className="flex space-x-2">
                <a 
        ...
        <AnimatedCard className="mb-8" delay={500}>
          <CardHeader>
            <div className="flex justify-between items-start">
        ...
        <AnimatedCard delay={600}>
          <CardHeader>
            <div className="flex justify-between items-start">
              <CardTitle className="text-white">Algorithm Solutions</CardTitle>
              <div className="flex space-x-2">
                <a 
