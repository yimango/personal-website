  ...
  return (
    <html lang="en" className="dark">
      <body className={`${inter.className} bg-gray-900 text-gray-100`}>
        <div className="min-h-screen flex flex-col bg-[url('/background.jpg')] bg-cover bg-fixed bg-center">
          <div className="backdrop-blur-sm backdrop-brightness-50 min-h-screen flex flex-col">
            <header className="bg-gray-900 bg-opacity-60 border-b border-gray-700 sticky top-0 z-10">
            ...
            <footer className="bg-gray-900 bg-opacity-60 text-white py-6">
